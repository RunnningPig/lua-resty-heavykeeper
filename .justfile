...
install-lualib:
    {{INSTALL}} -d {{DESTDIR}}{{LUA_LIB_DIR}}/resty/heavykeeper
    {{INSTALL}} -m 664 lib/resty/heavykeeper/*.lua {{DESTDIR}}{{LUA_LIB_DIR}}/resty/heavykeeper
    {{INSTALL}} -m 664 lib/resty/heavykeeper.lua {{DESTDIR}}{{LUA_LIB_DIR}}/resty

install: build install-lualib
    {{INSTALL}} -m 775 {{RELEASE_DIR}}/libheavykeeper.{{SHLIB_EXE}} {{DESTDIR}}{{LUA_LIB_DIR}}/libheavykeeper.{{SHLIB_EXE}}


install-debug: build-debug install-lualib
    {{INSTALL}} -m 775 {{DEBUG_DIR}}/libheavykeeper.{{SHLIB_EXE}} {{DESTDIR}}{{LUA_LIB_DIR}}/libheavykeeper.{{SHLIB_EXE}}
